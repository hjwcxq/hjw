...
import com.tv189.dzlc.adapter.po.log.FormFile;
...
public class HttpUtils {
     ...
     * @throws IOException
     */
	static public String sendRequestByHeaders(String url, String urlParam,Map headers)
    ...
    public static String put(String path, Map<String, String> params, FormFile file) throws Exception {
